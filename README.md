...
2. **Attach**를 눌러 `Waiting for cooperative target` 상태로 만듭니다.
...
- Attach, Launch, Stop, Restart, Detach, Refresh
- Port와 token
- 연결 상태와 Safe Mode
...
- Modules, Classes 및 GC-tracked objects의 현재 단계 안내
