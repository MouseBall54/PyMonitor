...
Agent suite 96개는 CPython 3.10.18, 3.11.9, 3.12.9, 3.13.7,
3.14.0rc2에서 NumPy·pandas·Matplotlib을 함께 설치한 상태로 통과했습니다
(런타임별 비지원 기능은 예상대로 skip). .NET Release suite는 App 72개,
Protocol 5개, Integration 2개로 총 79개가 통과했습니다. VS Code
